    ...
    async def _run():
        ...
        if sys.platform != "win32":
            for sig in (signal.SIGINT, signal.SIGTERM):
                inner_loop.add_signal_handler(sig, lambda s=sig: _handle_signal(s, shutdown_hook, inner_loop))  # noqa: E501
        ...
        try:
            ...
            console.print("[yellow]\nKeyboardInterrupt received — initiating graceful shutdown...[/yellow]")  # noqa: E501
        finally:
            await shutdown_hook()
